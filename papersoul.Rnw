...
lev <- levels(soul$QSB)
census.data %<>%
        mutate(QSB = factor(census.data$QSB, labels=lev) ) %>%
...
<<census,dependson='data', echo=FALSE,results='hide',warning=FALSE,message=FALSE,eval=FALSE>>=
...
<<cluster, dependson='data',echo=FALSE,warning=FALSE, cache=TRUE,eval=FALSE>>=
...
<<importance, dependson=c('data','cluster'), echo=FALSE,results='hide', cache=TRUE,warning=FALSE,message=FALSE,eval=FALSE>>=
...
\begin{figure}[hbpt] 
\centering
<<mapita,dependson='data',echo=FALSE, fig.height=6,message=FALSE,warning=FALSE,warning=FALSE>>=
...
<<race, echo=FALSE, dependson=c( 'data' ), message=FALSE, fig.height=7>>= 
