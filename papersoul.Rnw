...
found in \cite{soul2}. A reproducible version of this paper is placed in the following GitHub repository: https://github.com/COSTDataExpo2013/DaSilvaAlvarez.
