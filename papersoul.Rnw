...
mapp <- get_googlemap(location = 'united states', zoom = 4, maptype = "terrain")

aux.mer <- inner_join(lon.lat, 
                 select(census.data.new, QSB,pop100), 
                 by = c('Community'='QSB') )
...
@
  \caption{Location of the 26 communities analyzed, size of dot represent population. Only two communities on the west coast are included. \label{map}}
\end{figure}
